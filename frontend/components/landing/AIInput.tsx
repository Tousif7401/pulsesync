      ...
      <div className="relative">
        ...
        <div className="relative bg-[#0a0a0a] rounded-[24px] border border-white/5 overflow-hidden">
              ...
              {messages.length === 0 && (
                ...
                >
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-2xl bg-white/10 border border-white/5 flex items-center justify-center mb-6"
                  >
              ...
              {messages.map((message) => (
                ...
                >
                  <div className={`max-w-[85%] ${
                    message.role === 'user'
                      ? 'bg-white rounded-2xl rounded-tr-md px-5 py-3.5'
          ...
          <div className="px-8 pb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-white/10 rounded-2xl blur-xl opacity-0 hover:opacity-100 transition-opacity duration-500" />
              <div className="relative flex items-center gap-3 bg-[#111] rounded-2xl border border-white/10 focus-within:border-white/30 transition-colors">
                <input
                  type="text"
                  value={input}
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white/70 hover:text-white transition-all"
              >
