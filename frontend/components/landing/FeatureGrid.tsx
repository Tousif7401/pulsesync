          ...
          {mainFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#111111] rounded-3xl p-10 border border-white/5 hover:border-[#5235ef]/30 transition-all group"
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#5235ef] to-[#8771ff] flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform">
          ...
          {subFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#111111] rounded-3xl p-8 border border-white/5 hover:border-[#5235ef]/30 transition-all group"
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#FF6B6B] to-[#ff8e8e] flex items-center justify-center text-white mb-5 group-hover:scale-110 transition-transform">
